...
class EvolutionCheckpointer:
    ...
    def save_checkpoint(
        ...
        checkpoint_data = {
            ...
            "generation_snapshots": self._serialize_snapshots(checkpoint.generation_snapshots),
            "context": checkpoint.context,
            "random_state": checkpoint.random_state,
            "metadata": checkpoint.metadata,
            "checkpoint_time": checkpoint.checkpoint_time.isoformat() if checkpoint.checkpoint_time else None,
        }
        ...
        try:
            ...
            logger.info(f"Saved checkpoint {checkpoint_id} at generation {checkpoint.generation}")
    ...
    def load_checkpoint(self, checkpoint_id: str) -> Optional[EvolutionCheckpoint]:
        ...
        try:
            ...
            snapshots = self._deserialize_snapshots(data.get("generation_snapshots", []))
            ...
            checkpoint = EvolutionCheckpoint(
                ...
                if data.get("checkpoint_time") else None,
            )
            
            logger.info(f"Loaded checkpoint {checkpoint_id} from generation {checkpoint.generation}")
            return checkpoint
    ...
    def _serialize_population(self, population: List[IndividualFitness]) -> List[Dict[str, Any]]:
        ...
        for individual in population:
            ...
            fitness_data = {
                ...
                "evaluated_at": individual.evaluated_at.isoformat() if individual.evaluated_at else None,
            }
    ...
    def _deserialize_population(self, data: List[Dict[str, Any]]) -> List[IndividualFitness]:
        ...
        for fitness_data in data:
            ...
            individual = IndividualFitness(
                ...
                evaluated_at=datetime.fromisoformat(fitness_data["evaluated_at"])
                if fitness_data.get("evaluated_at") else None,
            )
    ...
    def _serialize_snapshots(self, snapshots: List[PopulationSnapshot]) -> List[Dict[str, Any]]:
    ...
    def _deserialize_snapshots(self, data: List[Dict[str, Any]]) -> List[PopulationSnapshot]:
        ...
        for snapshot_data in data:
            snapshot = PopulationSnapshot(
                ...
                if snapshot_data.get("timestamp") else None,
            )
