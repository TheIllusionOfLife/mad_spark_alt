...
Format each pattern on a new line starting with "I:".""",
    ...
    def get_adaptive_prompt(
        ...
        return template.format(prompt=prompt, previous_insights=previous_insights)
    ...
    def get_complexity_adjusted_params(
        ...
        if complexity == ComplexityLevel.SIMPLE:
            return {"max_tokens": 200, "temperature": 0.5}
...
def get_complexity_adjusted_params(
    ...
    Returns:
        Dictionary of adjusted parameters
    """
    return adaptive_generator.get_complexity_adjusted_params(
