...
class ThinkingAgentRegistry:
    ...
    def register_instance(self, method: ThinkingMethod, agent_instance: ThinkingAgentInterface) -> None:
        """
        ...
        logger.info(f"Registered thinking agent instance: {name} for method {method.value}")
