...
class TestEvolutionIntegration:
    ...
    async def test_evolve_qadi_generated_ideas(self):
        ...
        assert final_fitness >= initial_fitness * 0.9  # Allow small decrease due to randomness
        ...
        assert len(evolution_result.evolution_metrics["fitness_trend"]) == evolution_result.total_generations
    ...
    async def test_evolution_preserves_thinking_methods(self):
        ...
        evolution_request = EvolutionRequest(
            initial_population=mixed_ideas,
            config=config
        )
