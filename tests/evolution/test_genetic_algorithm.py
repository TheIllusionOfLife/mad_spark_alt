...
class TestGeneticAlgorithm:
    ...
    def setup_method(self):
        ...
        self.mock_fitness_evaluator.calculate_population_diversity = AsyncMock(return_value=0.7)
    ...
    async def test_evolve_with_exception(self):
        ...
        self.mock_fitness_evaluator.evaluate_population.side_effect = Exception("Test error")
...
class TestEvolutionConfig:
    ...
    def test_config_validation_invalid_elite_size(self):
        ...
        config = EvolutionConfig(
            population_size=10,
            elite_size=15  # Larger than population
        )
        assert not config.validate()