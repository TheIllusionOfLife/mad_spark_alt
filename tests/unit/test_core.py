...
class TestEvaluatorRegistry:
    ...
    def test_register_evaluator(self):
        ...
        assert "diversity_evaluator" in registry._layer_index[EvaluationLayer.QUANTITATIVE]
...
class TestCreativityEvaluator:
    ...
    async def test_evaluate_single_output(self):
        ...
        diversity_results = [r for r in quantitative_results if r.evaluator_name == "diversity_evaluator"]
