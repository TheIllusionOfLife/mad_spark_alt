#!/usr/bin/env python3
"""
QADI with Google API - Fast version
Usage: uv run python qadi_google_fast.py "Your question here"
"""
import asyncio
import sys
import os
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print('Usage: uv run python qadi_google_fast.py "Your question"')
        print('\nExamples:')
        print('  uv run python qadi_google_fast.py "how to live longer"')
        print('  uv run python qadi_google_fast.py "what are 3 ways to reduce stress"')
    else:
